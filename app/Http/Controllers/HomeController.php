...
class HomeController extends Controller
{
    ...
    {   
        ...
        $totales=DB::select('SELECT (select ifnull(sum(c.total),0) from compras c where DATE(c.fecha_compra)=curdate() and c.estado="Registrado") as totalcompra');


        return view('home', compact('comprasmes','ventasmes','ventasdia','productosvendidos','totales'));
    }
}
