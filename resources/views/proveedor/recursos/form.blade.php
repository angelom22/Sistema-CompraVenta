<div class="form-group row">
    ...
    <div class="col-md-9">
         <input type="text" name="nombre_empresa" id="nombre_empresa" class="form-control" placeholder="Ingrese el nombre de la empresa" required pattern="^[a-zA-Z_áéíóúñ\s.,]{0,50}$">
    </div>
</div>

<div class="form-group row">
    <label class="col-md-3 form-control-label" for="responsable">Responsable</label>
    <div class="col-md-9">
        <input type="text" name="responsable" id="responsable" class="form-control"  placeholder="Ingrese el nombre del responsable"  pattern="^[a-zA-Z_áéíóúñ\s]{0,30}$">
    </div>
</div>
